...
namespace FomodInstaller.Scripting.XmlScript
{
	public abstract class VersionCondition : ICondition
	{
        ...
        public abstract bool GetIsFulfilled(ConditionStateManager csmState, ICoreDelegates coreDelegates);
        ...
        public abstract string GetMessage(ConditionStateManager csmState, ICoreDelegates coreDelegates, bool invert);
